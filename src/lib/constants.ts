...
export const BRIQUES: Brique[] = [
  ...
  { id: 'mapaie', icon: `${CDN}/m/a/mapaie.png`, name: 'Ma Paie', label: 'Bulletins de paie', desc: '33% des salariés ont subi une erreur de paie', tag: 'Disponible', enjeu: '1 800–7 200€', ticket: '49–129€', available: true, url: '/mapaie' },
