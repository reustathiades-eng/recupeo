        ...
        <div className="flex items-center gap-12">
          <div className="flex-1 max-w-[640px]">
            ...
            <p className="text-[18px] text-white/[0.65] leading-relaxed max-w-[560px] mb-10">
              Notre simulateur applique la formule officielle INSEE pour calculer
              le montant revalorisé et les arriérés récupérables sur 5 ans. Calcul gratuit et instantané.
            </p>
            ...
            <div className="flex gap-8 flex-wrap">
              <div>
                <div className="font-heading text-[36px] font-extrabold text-emerald tracking-tight">15-20%</div>
                <div className="text-[13px] text-white/[0.45] mt-1 max-w-[140px]">de perte de pouvoir d&apos;achat après 5 ans</div>
              </div>
              <div className="w-px bg-white/10" />
              <div>
                <div className="font-heading text-[36px] font-extrabold text-white tracking-tight">5 ans</div>
                <div className="text-[13px] text-white/[0.45] mt-1 max-w-[120px]">d&apos;arriérés récupérables</div>
              </div>
              <div className="w-px bg-white/10" />
              <div>
                <div className="font-heading text-[36px] font-extrabold text-white tracking-tight">Gratuit</div>
                <div className="text-[13px] text-white/[0.45] mt-1 max-w-[120px]">Calcul instantané en ligne</div>
              </div>
            </div>
          </div>
            ...
            <div className="bg-white/[0.06] backdrop-blur-sm border border-white/10 rounded-2xl p-5 transform rotate-2 hover:rotate-0 transition-transform duration-500">
              <div className="bg-white rounded-xl p-4 shadow-lg">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <div>
                    <div className="text-[8px] font-bold text-slate-text">Revalorisation pension</div>
                    <div className="text-[6px] text-slate-muted">Indice INSEE appliqué</div>
                  </div>
                </div>
                <div className="bg-emerald/10 rounded-lg p-2.5 mb-3">
                  <div className="text-[7px] text-emerald font-semibold mb-0.5">&#x2191; Pension revalorisée</div>
                  <div className="text-emerald font-heading font-extrabold text-lg leading-none">485&euro;/mois</div>
                  <div className="text-[6px] text-slate-muted mt-0.5">au lieu de 400&euro; fixés en 2019</div>
                </div>
                <div className="bg-red-50 rounded-lg p-2.5 mb-3 border border-red-200">
                  <div className="text-[7px] text-red-500 font-semibold mb-0.5">Arriérés récupérables</div>
                  <div className="text-red-600 font-heading font-extrabold text-lg leading-none">3 060&euro;</div>
                  <div className="text-[6px] text-red-400 mt-0.5">sur les 5 dernières années</div>
                </div>
                <div className="space-y-1.5 mb-3">
                  <div className="flex justify-between text-[7px]">
                    <span className="text-slate-muted">Montant initial (2019)</span>
                    <span className="text-slate-text font-bold">400&euro;</span>
                  </div>
                  <div className="flex justify-between text-[7px]">
                    <span className="text-slate-muted">Hausse INSEE</span>
                    <span className="text-emerald font-bold">+21,3%</span>
                  </div>
                  <div className="flex justify-between text-[7px]">
                    <span className="text-slate-muted">Écart mensuel</span>
                    <span className="text-red-500 font-bold">+85&euro;/mois</span>
                  </div>
                </div>
                <div className="bg-emerald/10 rounded-lg p-2 text-center">
                  <div className="text-[7px] text-emerald font-bold">Courrier de réclamation inclus</div>
                </div>
              </div>
