...
import { MacautionReport } from '@/components/macaution/MacautionReport'
...
function RapportContent() {
  ...
  useEffect(() => {
    ...
    const generateReport = async () => {
      try {
        const res = await fetch('/api/macaution/full-report', {
          method: 'POST',
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-slate-bg pt-[80px]">
        <div className="text-center">
          ...
          <p className="text-sm text-slate-muted">Notre IA analyse votre dossier en détail. Cela prend 10 à 20 secondes.</p>
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-slate-bg pt-[80px]">
        <div className="text-center max-w-md">
          ...
          <a href="/macaution" className="cta-primary">← Retour au formulaire</a>
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="pt-[80px]">
      ...
      <div className="max-w-[1200px] mx-auto px-6 py-8">
        <AccountPrompt brique="macaution" />
      </div>
